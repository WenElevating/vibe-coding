...
class RunDetailPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return PageScroll(children: [
      ...
      _Timeline(l10n.runDetailReadFileTitle,
          'tests/login_test.dart                 +128 -45', '10:33', Icons.file_open_rounded, theme.green),
      _Timeline(l10n.runDetailSearchCodeTitle, l10n.runDetailSearchBody,
          '10:34', Icons.search_rounded, theme.muted),
      _Timeline(l10n.runDetailEditFileTitle,
          'lib/services/auth_service.dart       +32 -8', '10:35', Icons.edit_document, theme.green),
