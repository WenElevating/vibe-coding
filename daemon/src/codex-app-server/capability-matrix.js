...
const EXPLICIT_ROWS = [
  ...
  row('fuzzyFileSearch', 'request', 'experimental', 'file', 'supported', 'server route', 'planned', 'read', 'route test', 'Task 9 workspace-scoped read-only fuzzy file search route.'),
  row('fuzzyFileSearch/sessionStart', 'request', 'experimental', 'file', 'supported', 'server route', 'planned', 'read', 'route test', 'Task 9 workspace-scoped fuzzy file search session start route.'),
  row('fuzzyFileSearch/sessionUpdate', 'request', 'experimental', 'file', 'supported', 'server route', 'planned', 'read', 'route test', 'Task 9 workspace-scoped fuzzy file search session update route.'),
  row('fuzzyFileSearch/sessionStop', 'request', 'experimental', 'file', 'supported', 'server route', 'planned', 'read', 'route test', 'Task 9 workspace-scoped fuzzy file search session stop route.'),
  row('fuzzyFileSearch/sessionCompleted', 'notification', 'experimental', 'file', 'partial', 'server route', 'planned', 'read', 'matrix/event metadata only', 'Task 9 fuzzy search session completion notification metadata only; not mapped to stable mobile events yet.'),
  row('fuzzyFileSearch/sessionUpdated', 'notification', 'experimental', 'file', 'partial', 'server route', 'planned', 'read', 'matrix/event metadata only', 'Task 9 fuzzy search session update notification metadata only; not mapped to stable mobile events yet.'),
  row('feedback/upload', 'request', 'stable', 'diagnostics', 'diagnostic-only', 'matrix only', 'planned', 'network', 'manual-only', 'Task 9 diagnostic-only network upload; no product route exists yet.'),
  row('experimentalFeature/enablement/set', 'request', 'experimental', 'diagnostics', 'intentionally-blocked', 'matrix only', 'not planned', 'write', 'manual-only', 'Product feature flags require a first-party settings UX.'),
  row('mock/experimentalMethod', 'request', 'experimental', 'diagnostics', 'intentionally-blocked', 'matrix only', 'not planned', 'none', 'manual-only', 'Generated protocol test method; never productized.'),
  row('review/start', 'request', 'stable', 'diagnostics', 'diagnostic-only', 'server route', 'planned', 'permission', 'route test', 'Task 9 audited diagnostic review route; product review UX is not complete.'),
  row('attestation/generate', 'request', 'stable', 'diagnostics', 'diagnostic-only', 'server route', 'planned', 'permission', 'route test', 'Task 9 audited diagnostic attestation route; product attestation UX is not complete.'),
  row('thread/realtime/listVoices', 'request', 'stable', 'thread', 'supported', 'server route', 'planned', 'read', 'route test', 'Task 10 read-only realtime voice discovery route.'),
  row('thread/realtime/start', 'request', 'stable', 'thread', 'diagnostic-only', 'server route', 'planned', 'network', 'route test', 'Task 10 diagnostic-only until realtime streaming transport and mobile audio UX exist.'),
  row('thread/realtime/appendText', 'request', 'stable', 'thread', 'diagnostic-only', 'server route', 'planned', 'write', 'route test', 'Task 10 diagnostic-only until realtime streaming transport and mobile audio UX exist.'),
  row('thread/realtime/appendAudio', 'request', 'stable', 'thread', 'diagnostic-only', 'server route', 'planned', 'write', 'route test', 'Task 10 diagnostic-only until realtime streaming transport and mobile audio UX exist.'),
  row('thread/realtime/stop', 'request', 'stable', 'thread', 'diagnostic-only', 'server route', 'planned', 'write', 'route test', 'Task 10 diagnostic-only until realtime streaming transport and mobile audio UX exist.'),
  row('thread/realtime/started', 'notification', 'stable', 'thread', 'partial', 'server route', 'planned', 'none', 'matrix/event metadata only', 'Task 10 realtime notification metadata only; no mobile audio event stream yet.'),
  row('thread/realtime/closed', 'notification', 'stable', 'thread', 'partial', 'server route', 'planned', 'none', 'matrix/event metadata only', 'Task 10 realtime notification metadata only; no mobile audio event stream yet.'),
  row('thread/realtime/error', 'notification', 'stable', 'thread', 'partial', 'server route', 'planned', 'none', 'matrix/event metadata only', 'Task 10 realtime notification metadata only; no mobile audio event stream yet.'),
  row('thread/realtime/itemAdded', 'notification', 'stable', 'thread', 'partial', 'server route', 'planned', 'none', 'matrix/event metadata only', 'Task 10 realtime notification metadata only; no mobile audio event stream yet.'),
  row('thread/realtime/outputAudio/delta', 'notification', 'stable', 'thread', 'partial', 'server route', 'planned', 'none', 'matrix/event metadata only', 'Task 10 realtime notification metadata only; no mobile audio event stream yet.'),
  row('thread/realtime/sdp', 'notification', 'stable', 'thread', 'partial', 'server route', 'planned', 'none', 'matrix/event metadata only', 'Task 10 realtime notification metadata only; no mobile audio event stream yet.'),
  row('thread/realtime/transcript/delta', 'notification', 'stable', 'thread', 'partial', 'server route', 'planned', 'none', 'matrix/event metadata only', 'Task 10 realtime notification metadata only; no mobile audio event stream yet.'),
  row('thread/realtime/transcript/done', 'notification', 'stable', 'thread', 'partial', 'server route', 'planned', 'none', 'matrix/event metadata only', 'Task 10 realtime notification metadata only; no mobile audio event stream yet.'),
  ...
  row('item/fileChange/outputDelta', 'notification', 'stable', 'file', 'partial', 'conversation adapter', 'planned', 'none', 'matrix/event metadata only', 'Task 9 rich file notification metadata only; not mapped to stable mobile events yet.'),
  row('item/fileChange/patchUpdated', 'notification', 'stable', 'file', 'partial', 'conversation adapter', 'planned', 'none', 'matrix/event metadata only', 'Task 9 rich file notification metadata only; not mapped to stable mobile events yet.'),
  row('item/mcpToolCall/progress', 'notification', 'stable', 'mcp', 'partial', 'conversation adapter', 'planned', 'none', 'matrix/event metadata only', 'Task 9 rich MCP tool notification metadata only; not mapped to stable mobile events yet.'),
  row('item/plan/delta', 'notification', 'stable', 'item', 'partial', 'conversation adapter', 'planned', 'none', 'matrix/event metadata only', 'Task 9 rich plan notification metadata only; not mapped to stable mobile events yet.'),
  row('item/reasoning/summaryPartAdded', 'notification', 'stable', 'item', 'partial', 'conversation adapter', 'planned', 'none', 'matrix/event metadata only', 'Task 9 rich reasoning notification metadata only; not mapped to stable mobile events yet.'),
  row('item/reasoning/summaryTextDelta', 'notification', 'stable', 'item', 'partial', 'conversation adapter', 'planned', 'none', 'matrix/event metadata only', 'Task 9 rich reasoning notification metadata only; not mapped to stable mobile events yet.'),
  row('item/reasoning/textDelta', 'notification', 'stable', 'item', 'partial', 'conversation adapter', 'planned', 'none', 'matrix/event metadata only', 'Task 9 rich reasoning notification metadata only; not mapped to stable mobile events yet.'),
  row('turn/diff/updated', 'notification', 'stable', 'turn', 'partial', 'conversation adapter', 'planned', 'none', 'matrix/event metadata only', 'Task 9 rich turn diff notification metadata only; not mapped to stable mobile events yet.'),
