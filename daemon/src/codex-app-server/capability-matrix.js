...
const EXPLICIT_ROWS = [
  ...
  row('thread/inject_items', 'request', 'stable', 'thread', 'diagnostic-only', 'server route', 'planned', 'write', 'manual-only', 'Task 7 classified as diagnostic-only until product UX exists.'),
  row('thread/unsubscribe', 'request', 'stable', 'thread', 'diagnostic-only', 'server route', 'planned', 'write', 'manual-only', 'Task 7 classified as diagnostic-only until product UX exists.'),
  row('thread/compact/start', 'request', 'stable', 'thread', 'diagnostic-only', 'server route', 'planned', 'write', 'manual-only', 'Task 7 classified as diagnostic-only until product UX exists.'),
  row('thread/backgroundTerminals/clean', 'request', 'stable', 'thread', 'diagnostic-only', 'server route', 'planned', 'process', 'manual-only', 'Task 7 classified as diagnostic-only until product UX exists.'),
  row('thread/approveGuardianDeniedAction', 'request', 'stable', 'thread', 'diagnostic-only', 'server route', 'planned', 'permission', 'manual-only', 'Task 7 classified as diagnostic-only until product UX exists.'),
  row('thread/increment_elicitation', 'request', 'stable', 'thread', 'diagnostic-only', 'server route', 'planned', 'write', 'manual-only', 'Task 7 classified as diagnostic-only until product UX exists.'),
  row('thread/decrement_elicitation', 'request', 'stable', 'thread', 'diagnostic-only', 'server route', 'planned', 'write', 'manual-only', 'Task 7 classified as diagnostic-only until product UX exists.'),
